pattern_mal_cargo = {'Количество паллет (шт)': [4, 6],
                     ...
                     'Расстояние от подвески до земли(см)':[15, 20]},
                    'Масса(т)': [],
...
pattern_bol_cargo = {'Количество паллет (шт)': [20, 33],
                     'Габариты': {'Длинa кузова(м)': [5.8, 8], 'Ширина кузова(м)':[2.3, 2.45],'Высота кузова(м)':[2.2, 2.7],'Расстояние от подвески до земли(см)':[15, 20]},
                    'Масса(т)': [],
                    'Рабочий объем двигателя(л)': [],
                    'Максимальная скорость(км/ч)': []}
